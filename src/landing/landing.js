    ...
    <>
        ...
        <section className="landing-page">
            ...
            <div className="about">
                <h2>About Us</h2>
                <p>
                A place for cooks of all levels to share their delicious and creative recipes they have made with others and for cooks to recreate other's dishes and post pictures of the end result.
                </p>
            </div>
            <div className="how-it-works">
                <h3>How it works:</h3>
                <p>Post recipes that you have created onto your profile</p>
                <p>Browse Recipes in the "Explore" page, and sort by category or dietary tags</p>
